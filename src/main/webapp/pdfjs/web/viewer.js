...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = rootPath+'/pdfjs/web/images/';
  PDFJS.workerSrc = rootPath+'/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = rootPath+'/pdfjs/web/cmaps/';
...
function webViewerInitialized() {
  ...
  //这里修改打开文件的传入方式
  file = fileTOBeOpened ? fileTOBeOpened : appConfig.defaultUrl;
